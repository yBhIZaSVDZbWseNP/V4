REPO="https://raw.githubusercontent.com/yBhIZaSVDZbWseNP/V4/main/"
wwget -q -O /etc/systemd/system/limitssh.service "${REPO}limit/limitssh.service" && chmod +x limitssh.service >/dev/null 2>&1
